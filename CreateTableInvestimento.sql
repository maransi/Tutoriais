...
CREATE TABLE indexador(         id                  INT             UNSIGNED NOT NULL       AUTO_IMCREMENT PRIMARY KEY,
                                descricao           VARCHAR(50)     NOT NULL);

CREATE TABLE investidor(        id                  INT             UNSIGNED NOT NULL       AUTO_INCREMENT PRIMARY KEY,
                                nome                VARCHAR(50)     NOT NULL);

CREATE TABLE distribuidor(      id                  IN              UNSIGNED NOT NULL       AUTO_INCREMENT PRIMARY KEY,
                                nome                VARCHAR(50)     VARCHAR(50) );
